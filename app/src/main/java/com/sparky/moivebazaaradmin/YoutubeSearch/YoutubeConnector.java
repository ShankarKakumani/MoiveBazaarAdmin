    ...
    public class YoutubeConnector {
        ...
        public static final String KEY = "AIzaSyAtw1do1Y6k4ZwIwhlVCvwPKBTeLKozp1Q";

        //Package name of the app that will call the YouTube Data API
        public static final String PACKAGENAME = "com.sparky.youtubesearchmb";

        //SHA1 fingerprint of APP can be found by double clicking on the app signing report on right tab called gradle
        public static final String SHA1 = "59:E6:F5:92:B4:59:1A:E2:DF:02:B8:58:5E:41:72:3D:C0:7F:0D:62";

        //maximum results that should be downloaded via the YouTube data API at a time
        private static final long MAXRESULTS = 2;
